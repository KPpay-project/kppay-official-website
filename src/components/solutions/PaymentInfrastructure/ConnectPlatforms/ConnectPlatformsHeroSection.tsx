...
const ConnectPlatformsHeroSection = () => {
  return (
        ...
        <div className="relative z-10 container-padding pt-24 sm:pt-0 h-full flex items-center justify-center">
          <div className="text-center max-w-4xl">
            <h1 className="hero-heading">
              Orchestrate Payments for
              <br />
              Platforms and Marketplace
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="secondary" size="md" href="#talk-to-sales">
                Talk to Sales
              </Button>
              <Button variant="outlined-white" size="md" href="#view-use-cases">
                View Use Cases
              </Button>
            </div>
          </div>
...
export default ConnectPlatformsHeroSection;
